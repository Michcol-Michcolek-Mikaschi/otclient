...
function setSkillValue(id, value)
    ...
    if GameAdditionalSkills then
        ...
        if usePercentage then
            local needsDecimals = (id == 'skillId8' or id == 'skillId9' or id == 'skillId10' or id == 'skillId11' or id == 'skillId12' or id == 'skillId13' or id == 'skillId14' or id == 'skillId15' or id == 'skillId16')
